    ...
    return (
        <div className="dark:bg-white px-10">
            <dialog id="my_modal_2" className="modal">
                ...
                <div
                    className={`${customScroll.customScrolling} rounded-lg modal-box py-10 px-12 bg-white text-gray-900 mb-10 w-11/12 max-w-5xl divide-y-2 divide-gray-200 relative`}
                >
                    <form method="dialog">
