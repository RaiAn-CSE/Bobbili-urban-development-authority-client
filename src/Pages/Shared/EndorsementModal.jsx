    ...
    return (
        <div className='dark:bg-white px-10'>
            <dialog id="my_modal_2" className="modal">
                ...
                <div className={`${customScroll.customScrolling} rounded-lg modal-box py-10 px-10 bg-white text-gray-900 mb-10 w-11/12 max-w-5xl divide-y-2 divide-gray-200 relative`}>
                    <form method="dialog">
                    ...
                    <div className='py-5 pt-2'>
                        ...
                        <div className='mt-10'>
                            <p className='font-bold'>Documents Remarks and Recommendation: Shortfall</p>
                            <table className="min-w-full border text-center text-sm font-light border-neutral-500">
                                <td
                                    scope="col"
                                    className="border-r px-6 py-10 border-neutral-500"
                        ...
                        <div className='mt-10'>
                            <p className='font-bold'>Inspection Remarks and Recommendation : Shortfall</p>
                            <table className="min-w-full border text-center text-sm font-light border-neutral-500">
                                <td
                                    scope="col"
                                    className="border-r px-6 py-10 border-neutral-500"
