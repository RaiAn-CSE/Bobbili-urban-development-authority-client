  ...
  return (
    <div className="dark:bg-white">
      <dialog id="proceedingModal" className="modal">
        ...
        <div
          className={`${customScroll.customScrolling} rounded-lg modal-box py-10 bg-white text-gray-900  mb-10 w-11/12 max-w-5xl relative`}
        >
          <form method="dialog">
          ...
          <table className="min-w-full">
            <thead className="border border-gray-900 ">
              <tr>
                <th className="border-r border-neutral-500 p-2 text-center">
                  A
                </th>
