  ...
  return (
    <div className="flex items-center px-3 mt-5">
      ...
      <input
        id={id}
        type={text}
        className="basis-[65%] w-full px-3 py-2 border rounded-lg max-w-xs font-medium text-gray-600 bg-gray-50 border-gray-300 focus:border-violet-600 focus:outline-none focus:ring-2 ring-violet-200"
