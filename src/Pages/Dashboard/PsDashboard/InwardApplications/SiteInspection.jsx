...
const SiteInspection = () => {
    ...
    const collectInputFieldData = async (url) => {
        ...
        const proposedActivityApp = document.getElementById("proposedActivityApp").value;
        const proposedActivityObs = document.getElementById("proposedActivityObs").value;
        ...
        const whetherPermissionApp = document.getElementById("whetherPermissionApp").value;
        const whetherPermissionObs = document.getElementById("whetherPermissionObs").value;
        // Comments 
