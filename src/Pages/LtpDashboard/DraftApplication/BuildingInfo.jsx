    ...
    return (
        <div className='flex flex-col'>
            ...
            <div>
                ...
                <div className="divider m-0"></div>
                <div className='grid lg:grid-cols-5'>
                    <InputField id="name7" name="Proposed Plot area(in Sq.M.)" placeholder="Proposed Plot area(in Sq.M.)" />
                    <InputField id="name8" name="name1" placeholder="Total Plot are as on ground (in Sq.M.)" />
                    <InputField id="name9" name="name1" placeholder="Total Plot are as per document (in Sq.M.)" />
                    <InputField id="name10" name="name1" placeholder="Road Widening Area (in Sq.M.)" />
                    <InputField id="name11" name="name1" placeholder="Net Plot Area (in Sq.M.)" />
                    <InputField id="name12" name="name1" placeholder="Nature of Road" />
                    <InputField id="name12" name="name1" placeholder="Existing road (in Mts.)" />
                    <InputField id="name12" name="name1" placeholder="Proposed road (in Mts.)" />
                    <InputField id="name12" name="name1" placeholder="Market Value (per Sq.Yd.)" />
                    <InputField id="name12" name="name1" placeholder="Floor Name" />
                    <InputField id="name12" name="name1" placeholder="Plinth Area (in Sq.M.)" />
                    <InputField id="name12" name="name1" placeholder="Parking Area (in Sq.M.)" />
                    <div>
                        <button>+</button>
                    </div>
                </div>
                ...
                <div className='grid lg:grid-cols-5'>
                    <InputField id="name7" name="Proposed Plot area(in Sq.M.)" placeholder="Front setback (in M.)" />
                    <InputField id="name8" name="name1" placeholder="Rare setback (in M.)" />
                    <InputField id="name9" name="name1" placeholder="Side1 setback (in M.)" />
                    <InputField id="name10" name="name1" placeholder="Side 2 setback (in M.)" />
                    <InputField id="name11" name="name1" placeholder="Total Height of The Building Exclude Stilt (in Mts.)" />
                </div>
                <div className='flex'>
